...
<!--
Logic for display is required here, there are two cases: no recent advisories (whether active or ended) or active advisories
-->
...
<!--
Logic to only display this section if there is a SSB
-->
